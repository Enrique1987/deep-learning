...
def f(x0: float, x1: float) -> float:
    """Rosenbrock Function."""
    result: float = 100.0 * (x0**2.0 - x1) ** 2.0 + (x0 - 1.0) ** 2.0
    return result


def f_prime_x0(x0: float, x1: float) -> float:
    """Derivative of f w.r.t. x0."""
    result: float = 2.0 * (200.0 * x0 * (x0**2.0 - x1) + x0 - 1.0)
    return result


def f_prime_x1(x0: float, x1: float) -> float:
    """Derivative of f w.r.t. x0."""
    result: float = -200.0 * (x0**2.0 - x1)
    return result
